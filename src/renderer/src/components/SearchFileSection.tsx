...
interface SearchFileSectionProps {
  path: string;
  results: WorkspaceSearchMatch[];
  rootPath: string;
  onOpen: (result: WorkspaceSearchMatch) => void;
}

export function SearchFileSection({ path, results, rootPath, onOpen }: SearchFileSectionProps) {
  return (
